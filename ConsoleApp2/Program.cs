    ...
    internal class Program
    {
        ...
        static void RegisterCommands()
        {
            try
            {
                ...
                //FDictCommands.Add("006", new Action<GlobalClass>(command.Registration_users));
                //FDictCommands.Add("007", new Action<GlobalClass>(command.Registration_users));
                //FDictCommands.Add("008", new Action<GlobalClass>(command.Registration_users));
                //FDictCommands.Add("009", new Action<GlobalClass>(command.Registration_users));
                //FDictCommands.Add("010", new Action<GlobalClass>(command.Registration_users));
